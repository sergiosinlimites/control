...
%% % Controlador PID
Kp = 10; %  Hallado con otro archivo
Kd = 3.19; % 
Ki = 0.0001; % 

% Crear la función de transferencia para el controlador PID
C = Kp + Kd * s + Kd / s;  % Controlador PID

% Lazo cerrado con el controlador y planta
Go = feedback(C * Gplanta, 1);  % Lazo cerrado

% Graficar la respuesta al escalón y Bode
figure; hold on;
step(Go);
